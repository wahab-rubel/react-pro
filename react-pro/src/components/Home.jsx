...
const Home = () => {
                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Wahab rubel </b>
                          <b className="is-hidden">Designer </b>
                          <b className="is-visible">Developer</b>
                          <br/>
                          <p>This is my parsonal website</p>
                        </span>
                      </h1>
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          <li className="wow fadeIn" data-wow-delay=".4s">
                            <a
                              href="https://github.com/wahabshop"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay="1s">
                            <a
                              href="https://www.facebook.com/MAWRUBEL"
                              target="newtab"
                            >
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                        my name is md abdul wahab rubel. my home distric dinajpur
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-4 col-sm-6 col-xs-12 about-col">
                    <div className="about-image">
                      <img
                        src="/react-pro/public/images/parsonal-p/1.jpg"
                        alt="wahab-rubel"
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        <h3>Hello! my name is wahab</h3>
                        <div className="underline1 no-margin"></div>
                        <div className="underline2 no-margin"></div>
                      </div>
                      <p className="wow fadeIn">
                        I am a web developer from chittagong, bangladesh. I enjoy
              ...
              <div className="row love-row wow fadeIn">
                <div className="col-md-6">
                  <div className="skill-details text-left">
                    <p>
                      UI/UX involves planning and iterating a sites structure
                ...
                <div className="row main-row wow fadeIn">
                  <div className="col-md-12">
                    <div className="main-title text-center">
                      ...
                      <div className="underline2"></div>
                      <p>
                        I dont like to define myself by the work Ive done. I
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <div className="underline2"></div>
                      <p>
                        Here are a few design projects Ive worked on recently.
                        Want to see more?{" "}
                        <a className="underline2" href="#contact">
                          contact me.
                        </a>
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “md abdul wahab rubel is a clear communicator with the
                                      tenacity and confidence to really dig in
                                      to tricky design scenarios and the
                                      collaborative friction thats needed to
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4 col-sm-6">
                      <div className="blog-main">
                        ...
                        >
                          <img
                            src="/react-pro/public/images/images-1/1.png"
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".6s">
                        ...
                        ></i>
                        <h3>Portfolio</h3>
                        <p>https://github.com/wahabshop</p>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  function newFunction() {
    return "/react-pro/public/images/img1-1.jpg";
  }
};
